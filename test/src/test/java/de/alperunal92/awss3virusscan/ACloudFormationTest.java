package de.alperunal92.awss3virusscan;
...
public abstract class ACloudFormationTest extends AAWSTest {
    ...
    protected final void createalperunal92Stack(final String stackName, final String template, final Parameter... parameters) {
        final CreateStackRequest req = new CreateStackRequest()
                .withStackName(stackName)
                .withParameters(parameters)
                .withCapabilities(Capability.CAPABILITY_IAM)
                .withTemplateURL("https://s3-eu-west-1.amazonaws.com/alperunal92-aws-cf-templates-releases-eu-west-1/stable/" + template);
    ...
    protected final void createStack(final String stackName, final String template, final Parameter... parameters) {
        ...
        if (Config.has(Config.Key.TEMPLATE_DIR)) {
            ...
            req = req.withTemplateURL("https://s3-eu-west-1.amazonaws.com/alperunal92-aws-s3-virusscan/" + template);
        }
        this.cf.createStack(req);
        this.waitForStack(stackName, FinalStatus.CREATE_COMPLETE);
    }
